...
- Hero banner collage kiểu VM Travel (ảnh Việt Nam, palette vàng cam/đỏ cờ/xanh).
- Search bar nổi bật ở hero.
...
- Bộ lọc: Destination, Price range, Duration, Departure Date, Tour Type, Max People, **Season** (Summer / Winter / Year-round), **Operation Type** (Self-operated / Partner).
- Sort: Price low-high, Popular, Newest.
...
- **Online Payment** (Stripe + VNPay/MoMo) — thay thế "Pay Later" cho khách muốn trả trước.
