...
- `pnpm build` completes locally or in CI without hanging. **Done locally 2026-05-30.**
- Generated migration is reviewed and applied successfully in Preview/Production. **Reviewed locally; live application still needs verification.**
