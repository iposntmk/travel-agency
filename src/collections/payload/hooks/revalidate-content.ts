...
export const revalidateCarRentalAfterChange = afterChange("car-rentals", "car-rental");
export const revalidateCarRentalAfterDelete = afterDelete("car-rentals", "car-rental");
...
export const revalidateAttractionAfterChange = afterChange("attractions", "attraction");
export const revalidateAttractionAfterDelete = afterDelete("attractions", "attraction");
export const revalidatePromotionsAfterChange = afterCollectionChange("promotions");
export const revalidatePromotionsAfterDelete = afterCollectionDelete("promotions");
export const revalidateReviewsAfterChange = afterCollectionChange("reviews");
export const revalidateReviewsAfterDelete = afterCollectionDelete("reviews");
export const revalidateExperienceAfterChange = afterChange("experiences", "experience");
export const revalidateExperienceAfterDelete = afterDelete("experiences", "experience");
